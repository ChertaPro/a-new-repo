...
Antes de tocar una sola línea de CSS, definí qué quería transmitir: un blog técnico pero con algo de personalidad, sin caer en lo genérico de "fondo blanco, Helvetica, azul de link default". Terminé en una paleta con un acento azul marino y tipografía serif (Lora) para los títulos — un aire más editorial, tipo publicación seria, en contraste con el cuerpo del texto en una sans-serif normal para no sacrificar legibilidad en párrafos largos.
